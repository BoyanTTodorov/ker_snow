...
FROM (
    ...
    WHERE GS.DET_IS_DELETED = FALSE
        AND O9.DET_IS_DELETED = FALSE AND P1.DET_IS_DELETED = FALSE
...
GROUP BY
    ORDER_SUB, SEQUENCE_SUB, PARCEL_SUB, ITEM_SUB, QUALITY_SUB, QUANTITY_SUB, MODEL_SUB, PRODUCT_CATEGORY_SUB,
    SUBCAT_SUB, HAZ_FUB, FSC_SUB, JWL_SUB, JWL_PACK_SUB, HAL_SUB, CITES_SUB, CEE_SUB,
    PARCEL_TYPE_FOR_SUB, OIU_PARCEL_SUB, PARCEL_TYPE_ACT_SUB, IPFH_SUB, IPFW_SUB, IPFL_SUB,
    ...
    UPDATED_DATE_SUB, UPDATED_DATE_ORACLE_SUB, GSNAOD, GSNODP, GSNAPP, GSNPRE, CARTON_LINE_SEQUENCE;